...
Para rodar este projeto localmente, você precisará ter o Node.js e o npm instalados.
...
Crie um novo cluster e um banco de dados (sugerido: spotifyAula).

Dentro do banco, crie duas coleções: artists e songs.

No arquivo back-end/api/connect.js, substitua a string URI pela sua própria string de conexão do MongoDB Atlas.

Para popular o banco: Rode o script insertMany.js para adicionar os dados iniciais de artistas e músicas.
